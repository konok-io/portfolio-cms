...
return new class extends Migration
{
    public function up(): void
    {
        Schema::table('resume_settings', function (Blueprint $table) {
            ...
            $table->string('footer_bg_color')->default('#1a1a2e')->after('header_bg_color');
        });
    }
    ...
    {
        Schema::table('resume_settings', function (Blueprint $table) {
            $table->dropColumn(['heading_color', 'text_color', 'background_color', 'header_bg_color', 'footer_bg_color']);
        });
    }
};
