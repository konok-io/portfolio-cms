    ...
    <div class="container">
        <div class="row gy-4">
            <div class="col-lg-3">
                ...
                <p class="small mb-3">{{ page_content('footer', 'tagline', app()->getLocale()) }}</p>
            ...
            <div class="col-lg-3 col-md-4">
                ...
                <form class="d-flex gap-2" action="{{ route('subscribe.store') }}" method="POST">
                    ...
                    <input type="email" name="email" class="form-control form-control-sm @error('email') is-invalid @enderror" placeholder="{{ page_content('footer', 'newsletter_placeholder', app()->getLocale()) }}" aria-label="Email" required>
        ...
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-center small">
            <p class="mb-0">&copy; {{ date('Y') }} {{ $siteSetting->site_name ?? 'Portfolio CMS' }}. {{ page_content('footer', 'copyright', app()->getLocale()) }}</p>
            <p class="mb-0">{{ page_content('footer', 'copyright_prefix', app()->getLocale()) }}</p>
        </div>
    </div>
</footer>
