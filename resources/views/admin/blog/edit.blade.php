...
<div class="admin-page-header">
    <div>
        ...
        <p class="admin-breadcrumb mb-0"><a href="{{ route('admin.blog.index') }}">Blog</a> / Edit</p>
    </div>
</div>
                ...
                <div class="card-body-custom">
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="short_description" class="form-control" rows="2" maxlength="500">{{ old('short_description', $blog->short_description) }}</textarea>
                        </div>
                        <div class="col-12">
        ...
        <div class="col-lg-4">
            ...
            <div class="admin-card mb-3">
                ...
                <div class="card-body-custom text-center">
                    <img id="featuredPreview" src="{{ $blog->featured_image_url ?? 'https://placehold.co/400x300/e2e8f0/64748b?text=No+Image' }}" class="rounded-3 mb-3 w-100" style="aspect-ratio:4/3; object-fit:cover;">
