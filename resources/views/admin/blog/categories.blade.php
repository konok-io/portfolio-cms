...
<div class="admin-page-header">
    <div>
        ...
        <p class="admin-breadcrumb mb-0"><a href="{{ route('admin.blog.index') }}">Blog</a> / Categories</p>
    </div>
</div>
                    ...
                    <tbody>
                        @forelse($categories as $category)
                            <tr>
                                ...
                                <td class="text-end">
                                    <form action="{{ route('admin.blog.categories.destroy', $category) }}" method="POST" class="d-inline" data-confirm-delete="Delete this category? Posts will become uncategorized.">
                                        @csrf @method('DELETE')
