...
<head>
    ...
    <title><?php echo $__env->yieldContent('seo_title', $seoMeta->meta_title ?? $siteSetting->site_name ?? 'Portfolio CMS'); ?></title>
    <meta name="description" content="<?php echo $__env->yieldContent('meta_description', ($seoMeta->meta_description ?? '')); ?>">
    <meta name="keywords" content="<?php echo $__env->yieldContent('meta_keywords', ($seoMeta->meta_keywords ?? '')); ?>">

    <meta property="og:title" content="<?php echo $__env->yieldContent('title', ($siteSetting->site_name ?? 'Portfolio CMS')); ?>">
    <meta property="og:description" content="<?php echo $__env->yieldContent('meta_description', ($seoMeta->meta_description ?? '')); ?>">
    <?php if($seoMeta && $seoMeta->og_image): ?>
        <meta property="og:image" content="<?php echo e(asset('storage/' . $seoMeta->og_image)); ?>">
    <?php endif; ?>

    <?php if($siteSetting && $siteSetting->favicon): ?>
        <link rel="icon" href="<?php echo e(asset('storage/' . $siteSetting->favicon)); ?>">
    <?php endif; ?>
